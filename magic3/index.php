...
define('CAMPAIGN_ID', "29b12b57e1d1a042bce50f5724c2fd12");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'd076100a55b61d1224d470bf4f5bc0c4');
define('MP_PARAM_NAME', '_sl');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'f7ca73f81604b0ac14b7e3a56aca6e2d');
define('CHECK_MCPROXY_VALUE', '3632e769eac45cb3de870648d8500d8ac3d16725b338b504c5da5f2e3dde1b2e');
